    ...
    return (
        <div className="AddMovie">
            <form onSubmit={submitted}>
                ...
                <div className="row mb-3">
                    <label htmlFor="colFormLabel" className="col-sm-2 col-form-label">Youtube </label>
                    <div className="col-sm-10">
                ...
                <div className="input-group mb-3">
                    <span className="input-group-text" id="basic-addon3">url de votre film </span>
                ...
                <div className="col-12">
                    <button className="btn btn-primary" type="submit">Ajouter un film</button>
                </div>
            </form>
        </div>
    )
